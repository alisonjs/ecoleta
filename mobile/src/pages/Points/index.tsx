...
const Points = () => {
    ...
    useEffect(() => {
      async function loadPosition(){
        ...
        if( status !== 'granted'){
          Alert.alert('Ooops...','Precisamos de sua permissão para ober a sua localização.');
          return;
        }
    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <Text style={styles.title}>
              <Emoji name="grin" style={{fontSize: 20}} /> Bem vindo.
            </Text>
                  ...
                  initialRegion={{
                    ...
                    {points.map(point => (
                      ...
                      coordinate={{
                        ...
                        <View style={styles.mapMarkerContainerAfter} />
                      </Marker>
                    ))}
                  </MapView>
                )}
